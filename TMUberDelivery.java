...
public class TMUberDelivery extends TMUberService
{
  ...
  public TMUberDelivery(Driver driver, String from, String to, User user, int distance, double cost, String restaurant, String order, String TYPENAME)
  {
  ...
  public boolean equals(Object other)
  {
    ...
    TMUberDelivery alternative = (TMUberDelivery) other;
        
    return super.equals(alternative) && Objects.equals(restaurant, alternative.restaurant) && Objects.equals(foodOrderId, alternative.foodOrderId); 
  }
  /*
